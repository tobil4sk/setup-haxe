...
// * NOTE https://github.com/HaxeFoundation/neko/releases/download/v2-4-0/neko-2.4.1-linux64.tar.gz
// * NOTE https://github.com/HaxeFoundation/neko/releases/download/v2-4-0/neko-2.4.1-osx-universal.tar.gz
// * NOTE https://github.com/HaxeFoundation/neko/releases/download/v2-4-0/neko-2.4.1-win64.zip
export class NekoAsset extends Asset {
  ...
  get downloadUrl() {
    return `https://build.haxe.org/builds/neko/linux64/neko_2024-07-04_master_ba49f62.tar.gz`;
